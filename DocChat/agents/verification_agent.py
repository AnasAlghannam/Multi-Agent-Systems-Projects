...
class VerificationAgent:
    def __init__(self):
        """Initialize the verification agent with a chat model."""
        # Temperature 0: verification must be consistent run to run.
        self.model = get_llm(temperature=0.0, max_tokens=400)
