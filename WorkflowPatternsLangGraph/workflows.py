...
# Tracing (optional)
# ---------------------------------------------------------------------------
# When Langfuse credentials are present, every model call and graph step is
# traced. Without them the callback list is empty and nothing changes.
...
TRACING_CONFIG = {"callbacks": get_callbacks()}
